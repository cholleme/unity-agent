...
- AI chatbot integration in Unity Editor
...
1. Open the Unity project from the `UnityAgents` folder
2. Configure the chatbot settings through the Unity Editor menu
3. Use the agent tools for scene manipulation and asset management
